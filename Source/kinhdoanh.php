...
<ul2>
    ...
    <li2><a href="xahoi.php">XÃ HỘI</a></li2>
    ...
    <li2><a class="active" href="kinhdoanh.php">KINH DOANH</a></li2>
...
<?php
	...
	$sql = "SELECT * FROM official_info where theloai=N'Kinh doanh' ORDER BY  dohot DESC, ngay DESC";
