...
<div class="navbar navbar-inverse navbar-lower" role="navigation">	
	...
	<div class="collapse navbar-collapse">
        ...
        <li><a class="active" href="index.php">TỔNG HỢP</a></li>
        ...
        <li class="active"><a href="chinhtri.php">CHÍNH TRỊ</a></li>
...
<?php
	...
	$sql = "SELECT * FROM official_info where theloai=N'Chính trị' ORDER BY  dohot DESC, ngay DESC";
